...
from lib.pooling import WildcatPool2d, ClassWisePool, ClassWisePool_avg
...
def resnet101_base(num_classes, pretrained=True, kmax=1, kmin=None, alpha=1, num_maps=1):
