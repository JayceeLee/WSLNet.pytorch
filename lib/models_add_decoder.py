...
class ResNetWSL_decoder(nn.Module):
    ...
    def __init__(self, model, num_classes, num_maps, pooling=None):
        ...
        self.group_conv2 = nn.Conv2d(num_classes*num_maps, num_classes, kernel_size=1, stride=1, padding=0, groups=num_classes, bias=True)
    ...
    def get_config_optim(self, lr, lrp):
        return [{'params': self.features.parameters(), 'lr': lr * lrp},
                ...
                {'params': self.group_conv2.parameters()},
...
def resnet50_decoder(num_classes, pretrained=True, kmax=1, kmin=None, alpha=1, num_maps=1):
    ...
    return ResNetWSL_decoder(model, num_classes, num_maps, pooling=pooling)

def resnet101_decoder(num_classes, pretrained=True, kmax=1, kmin=None, alpha=1, num_maps=1):
