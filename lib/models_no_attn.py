...
def resnet50_no_attn(num_classes, pretrained=True, kmax=1, kmin=None, alpha=1, num_maps=1):
...
def resnet101_no_attn(num_classes, pretrained=True, kmax=1, kmin=None, alpha=1, num_maps=1):
